...
public class CreateUserPageImpl extends AbstractCMCPage implements CreateUserPage{
	...
	//public static final Identifier LOGON_ID = Identifier.byXPath("//ac-user-account/div[2]/div[2]/div[2]/div[1]/div/input[1]");
	public static final Identifier LOGON_ID = Identifier.byId("logonid");

	
	//public static final Identifier TITLE = Identifier.byXPath(".//input[@id='title']");
	
	//public static final Identifier TITLE = Identifier.byXPath("//ibm-dropdown/div/button");
	public static final Identifier TITLE = Identifier.byXPath("//*[@id='title']//button");
	
	
	public static final Identifier FIRST_NAME = Identifier.byXPath(".//input[@id='firstName']");
	
	//public static final Identifier FIRST_NAME = Identifier.byXPath("//ac-user-contact/div[2]/div[2]/div[2]/div[1]/div/div[2]/div[1]/input");
	...
	//public static final Identifier LAST_NAME = Identifier.byXPath("//ac-user-contact/div[2]/div[2]/div[2]/div[1]/div/div[2]/div[2]/input");

	public static final Identifier PASSWORD = Identifier.byXPath(".//input[@id='password']");
	//public static final Identifier PASSWORD = Identifier.byXPath("//ac-user-account/div[2]/div[2]/div[2]/div[1]/div/div[4]/input");
	
	
	//public static final Identifier PASSWORD_CONFIRM = Identifier.byXPath(".//input[@id='passwordConfirm']");
	public static final Identifier PASSWORD_CONFIRM = Identifier.byXPath(".//input[@id='passwordVerify']");
	...
	public static final Identifier STREET_ADDRESS2 = Identifier.byXPath(".//input[@id='address2']");
	
	//public static final Identifier STREET_ADDRESS = Identifier.byXPath("//ac-user-contact//div[text()='Street address']//following::input[1]");
	
	public static final Identifier CITY = Identifier.byXPath(".//input[@id='city']");
	//public static final Identifier CITY = Identifier.byXPath("//ac-user-contact//div[text()='City']//following::input[1]");
	
	public static final Identifier STATE = Identifier.byXPath(".//input[@id='country']");
	//public static final Identifier STATE = Identifier.byXPath("//ac-user-contact//div[text()='City']//following::input[2]");

	//public static final Identifier ZIP = Identifier.byXPath(".//input[@id='zip']");
	//public static final Identifier ZIP = Identifier.byXPath("//ac-user-contact//div[text()='City']//following::input[3]");
	public static final Identifier ZIP = Identifier.byXPath(".//input[@id='zipCode']");

	
	//public static final Identifier EMAIL_ONE = Identifier.byXPath(".//input[@id='email1']");
	//public static final Identifier EMAIL_ONE = Identifier.byXPath("//ac-user-account/div[2]/div[2]/div[2]/div[1]/div/input[2]");
	public static final Identifier EMAIL_ONE = Identifier.byId("email");
	...
	//public static final Identifier ACCOUNT_POLICY_DROPDOWN = Identifier.byXPath("//ac-user-account//ibm-dropdown/div[1]/button");
	public static final Identifier ACCOUNT_POLICY_DROPDOWN = Identifier.byXPath("//*[@id='accountPolicy']//button");
	...
	//public static final Identifier ORGANIZATION_DROPDOWN = Identifier.byXPath("//ac-user-account//div[text()='Organization']//following::input");
	public static final Identifier ORGANIZATION_DROPDOWN = Identifier.byXPath(".//input[@id='organization']");

	
	
	public static final Identifier COUNTRY_DROPDOWN = Identifier.byXPath(".//n-dropdown[@id='countryDropdown']");
	
	public static final Identifier TITLEVAL = Identifier.byXPath("//ibm-dropdown-list/ul/li[text()='TITLE']");
	//public static final Identifier ACCOUNT_POLICY = Identifier.byXPath(".//span[(text() ='POLICY')]");
	public static final Identifier ACCOUNT_POLICY = Identifier.byXPath("//ibm-dropdown-list/ul/li[text()='POLICY']");
	...
	//public static final Identifier R_ORGANIZATION_DROPDOWN = Identifier.byXPath("//ac-user-roles//ibm-dropdown[1]//button");
	public static final Identifier R_ORGANIZATION_DROPDOWN = Identifier.byXPath("//*[@id='organizationName']//button");

	//public static final Identifier AVAILABLE_ROLES_DROPDOWN = Identifier.byXPath("//ac-user-roles//ibm-dropdown[2]//button");
	public static final Identifier AVAILABLE_ROLES_DROPDOWN = Identifier.byXPath("//*[@id='rolesList']//button");

	public static final Identifier R_ORGANIZATION_ITEM = Identifier.byXPath("//ibm-dropdown-list/ul/li[text()='RORGANIZATION']");

	//public static final Identifier R_ORGANIZATION_ITEM = Identifier.byXPath("//ibm-dropdown-list/ul/li[1]");
	
	public static final Identifier AVAILABLE_ROLES = Identifier.byXPath("//ibm-dropdown-list/ul/li[text()='AVAILABLEROLE']");
	
	//public static final Identifier AVAILABLE_ROLES = Identifier.byXPath("//ibm-dropdown-list/ul/li[2]");

	public static final Identifier INCLUDE_TAB = Identifier.byXPath("//*[@id='n-tab-0-header']");
	
	public static final Identifier EXCLUDE_TAB = Identifier.byXPath("//*[@id='n-tab-1-header']");

	//public static final Identifier FIND_A_GROUP_TO_INCLUDE = Identifier.byXPath("//*[@id='n-tab-0']/div/div/div[2]/input");
	public static final Identifier FIND_A_GROUP_TO_INCLUDE = Identifier.byXPath("//*[@id='groupsInput']");

	public static final Identifier FIND_A_GROUP_TO_EXCLUDE = Identifier.byXPath("//*[@id='n-tab-1']/div/div/div[2]/input");
	
	//public static final Identifier INCLUDE_GROUP_ITEM = Identifier.byXPath("//*[@id='n-tab-0']/div/div/div[2]/ul/li/ibm-checkbox/label[text()=' INCLUDEGROUP ']");
	public static final Identifier INCLUDE_GROUP_ITEM = Identifier.byXPath("//ibm-checkbox/label[text()=' INCLUDEGROUP ']");

	
	
	//public static final Identifier INCLUDE_GROUP_ITEM = Identifier.byXPath("//*[@id='n-tab-0']/div/div/div[2]/ul/li[1]/ibm-checkbox/label");

	
	public static final Identifier EXCLUDE_GROUP_ITEM = Identifier.byXPath("//*[@id='n-tab-1']//ul/li/ibm-checkbox/label[contains(text(),'EXCLUDEGROUP')]");
