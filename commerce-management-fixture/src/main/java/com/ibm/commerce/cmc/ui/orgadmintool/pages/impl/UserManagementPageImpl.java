...
public class UserManagementPageImpl extends AbstractCMCPage implements UserManagementPage{
	...
	public static final Identifier ADDUSER = Identifier.byXPath(".//button[(text() = 'New')]");
	...
	//public static final Identifier USER_LIST = Identifier.byXPath(".//td[(text() ='USER_ID')]");
	
	//public static final Identifier FIRST_NAME = Identifier.byXPath(".//span[@title='FIRSTNAME']");
	//public static final Identifier FIRST_NAME = Identifier.byXPath(".//td[text()='FIRSTNAME']");
	public static final Identifier FIRST_NAME = Identifier.byXPath(".//a[text()='FIRSTNAME']");

	//public static final Identifier LAST_NAME = Identifier.byXPath(".//span[@title='LASTNAME']");
	//public static final Identifier LAST_NAME = Identifier.byXPath(".//td[text()='LASTNAME']");
	public static final Identifier LAST_NAME = Identifier.byXPath(".//a[text()='LASTNAME']");
