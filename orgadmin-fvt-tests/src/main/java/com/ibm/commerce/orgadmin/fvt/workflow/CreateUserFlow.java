...
public class CreateUserFlow extends AbstractSingleSessionTest{
	...
	public CreateUserFlow setStreetAddress2(String streetAddress2) {
	...
	public CreateUserFlow setROrganization(String rorg) {
		this.rorg = rorg;
		return this;
	}
	
	public CreateUserFlow setRole(String role) {
		this.role = role;
		return this;
	}
	
	public CreateUserFlow setIncludeGroup(String includeGroup) {
		this.includeGroup = includeGroup;
		return this;
	}
	
	public CreateUserFlow setExcludeGroup(String excludeGroup) {
